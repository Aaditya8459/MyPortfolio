...
return ( <section
   id="hero"
   className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-10 pt-20"
 >
{/* Decorative lines */} <div className="absolute top-[15%] left-[5%] w-[1px] h-[150px] bg-gradient-to-b from-transparent via-brand-pink/20 to-transparent hidden lg:block" />
  ...
  >
    ...
    <div className="lg:col-span-7 text-center lg:text-left order-2 lg:order-1">
      ...
      >
        ...
        <span className="text-xs sm:text-sm font-medium tracking-wider text-brand-pink/90">
      ...
      <motion.p
        variants={itemVariants}
        className="text-base sm:text-lg md:text-xl text-white/40 font-light tracking-wide mb-8 max-w-lg mx-auto lg:mx-0"
      >
        Building intelligent, scalable software with AI.
      </motion.p>
      ...
      >
        <motion.button
          ...
          style={{
            ...
            boxShadow: "0 4px 30px rgba(193, 53, 132, 0.4)",
          }}
          whileHover={{
            scale: 1.05,
            y: -3,
      ...
      <motion.div
        variants={itemVariants}
        className="flex flex-wrap gap-6 sm:gap-8 mt-10 sm:mt-12 justify-center lg:justify-start"
      >
        {[
          {
            num: "3+",
          ...
          >
            <p className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-brand-pink to-brand-magenta bg-clip-text text-transparent">
              {stat.num}
            </p>
    ...
    >
      ...
      <motion.div
        ...
        style={{
          border: "1px solid rgba(255,255,255,0.1)",
          boxShadow: "0 25px 80px rgba(193, 53, 132, 0.2)",
        }}
        whileHover={{
          rotateY: 8,
          rotateX: -5,
      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] text-brand-pink font-bold tracking-[0.2em] uppercase">
                Currently Building
              </p>
